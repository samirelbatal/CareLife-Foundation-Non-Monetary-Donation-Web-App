...
if (info) {
  ...
  document.getElementById("label1-6").innerText = "3";
  document.getElementById("label1-7").innerText = "20" ;
  document.getElementById("label1-8").innerText = "English,Arabic,History";
  ...
  document.getElementById("label6").innerText = "Pro-Bono Classes per Week: ";
  document.getElementById("label7").innerText = "Pro-Bono Students per class: ";
  document.getElementById("label8").innerText = "Teacher Subjects: ";
} else {
