...
function addRow(id, name, email, type, address, contact) {
    ...
    cell5.querySelector('.edit-icon').addEventListener('click', function() {
        ...
        editRow(id, name, email, type, address, contact);
    });
    ...
    cell6.querySelector('.view-details-button').addEventListener('click', function() {
        ...
        showOrganizationDetails(id, name, email, type, address, contact);
    });
}
...
function editRow(id, name, email, type) {
    // Get the modal
...
function showOrganizationDetails(id, name, email, type,address, contact) {
    // Get the modal
...
function InsertAllRows() {
    userData.forEach(function(user) {
        addRow(user.id, user.name,user.email, user.type,user.address,user.contact);
    });
}
